       ...
       <table align="center" width="650" cellpadding="0" cellspacing="0"
              ...
              <tr>
                     <td style="background:#0d6efd;color:#fff;text-align:center;padding:30px;">
                            <h1 style="margin:0;font-size:28px;">Pagamento gerado</h1>
                     </td>
              </tr>
              <tr>
                     <td style="padding:40px;">
                            ...
                            <p style="font-size:16px;color:#555;line-height:1.7;">Seu pagamento foi gerado e está
                                   disponível.</p>
                            ...
                            <?php if ($pixCopiaCola !== ""): ?>
                                   <p style="font-size:14px;color:#555;"><strong>PIX Copia e Cola:</strong></p>
                                   <div
                                          style="background:#f8f9fa;border:1px solid #dee2e6;padding:12px;border-radius:6px;word-break:break-all;font-size:12px;">
                                          <?= htmlspecialchars((string) $pixCopiaCola, ENT_QUOTES, "UTF-8"); ?>
                                   </div>
                            <?php endif; ?>

                            <?php if ($boletoLinhaDigitavel !== ""): ?>
                                   <p style="font-size:14px;color:#555;margin-top:20px;"><strong>Linha digitável:</strong></p>
                                   <div
                                          style="background:#f8f9fa;border:1px solid #dee2e6;padding:12px;border-radius:6px;word-break:break-all;font-size:13px;">
                                          <?= htmlspecialchars((string) $boletoLinhaDigitavel, ENT_QUOTES, "UTF-8"); ?>
                                   </div>
                            <?php endif; ?>

                            <hr style="border:none;border-top:1px solid #e5e5e5;margin-top:30px;">
                            <p style="font-size:13px;color:#888;">Este é um e-mail automático. Não responda esta
                                   mensagem.</p>
                     </td>
              </tr>
              <tr>
