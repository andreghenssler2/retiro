...
<body style="margin:0;padding:30px;background:#f5f6fa;font-family:Arial,Helvetica,sans-serif;">
       <table align="center" width="650" cellpadding="0" cellspacing="0"
              ...
              <tr>
                     <td style="background:#6f42c1;color:#fff;text-align:center;padding:30px;">
                            <h1 style="margin:0;font-size:28px;">Pagamento estornado</h1>
                     </td>
              </tr>
              <tr>
                     <td style="padding:40px;">
                            ...
                            <p style="font-size:16px;color:#555;line-height:1.7;">O pagamento anteriormente confirmado
                                   foi estornado. Consulte a administração caso precise de mais informações.</p>
